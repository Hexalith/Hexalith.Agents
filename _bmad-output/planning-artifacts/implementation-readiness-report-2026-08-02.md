...
excludedDocuments:
  ...
  - _bmad-output/planning-artifacts/prds/prd-agents-2026-06-23/polish-prose-prd.md
  - _bmad-output/planning-artifacts/prds/prd-agents-2026-06-23/polish-structure-prd.md
  - _bmad-output/planning-artifacts/prds/prd-agents-2026-06-23/polish-prose-addendum.md
  - _bmad-output/planning-artifacts/prds/prd-agents-2026-06-23/polish-structure-addendum.md
---
...
- PRD/addendum files prefixed `polish-prose-` or `polish-structure-` — alternate working variants.

No required document category is missing and no whole-versus-sharded duplicate conflict remains. The PRD, architecture, and UX document sets do not contain conventional `index.md` files.
