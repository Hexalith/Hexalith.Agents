...
| `LR-AUDIT-PROTECTION-DELETION` | Payload protection, authorized audit, retention/legal hold/export, cryptographic erasure/redaction, named projection purge, and safe tombstone evidence. Invalidated by protection, retention, export, deletion, or projection-inventory changes. |
