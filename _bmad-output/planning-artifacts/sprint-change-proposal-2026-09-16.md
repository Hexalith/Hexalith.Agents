...
- Builds `origin/main` contains catalog/audit target `000abf867abc3a99cfa74d39b6e73af05c78a602`, and Agents commit `01ead38` published on `origin/main` records that exact gitlink. The publication condition is satisfied, but `ARCH-A-15` remains open pending approval of `OD-DAPR-SECURITY-1`: Story 5.1 compatibility evidence covers the consumed Client/ASP.NET graph only, while Workflow compatibility remains Story 6.1 work.
