...
/// <summary>Requests support-safe generation evidence for an AgentInteraction.</summary>
/// <param name="AgentInteractionId">The AgentInteraction aggregate id.</param>
public sealed record GetAgentGenerationEvidenceQuery(string AgentInteractionId)
{
    ...
    public const string QueryType = "get-agent-generation-evidence";
}
