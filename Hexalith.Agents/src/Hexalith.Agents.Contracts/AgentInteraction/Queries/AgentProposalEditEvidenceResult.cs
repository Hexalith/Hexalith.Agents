...
/// <summary>
/// Structured result of an authorized Proposed-Agent-Reply edit-evidence inspection (AC4; FR-14, FR-15). On
...
/// exists in another tenant or leaks unrelated records (AD-12, AD-14). Mirrors
/// <see cref="AgentInteractionContextEvidenceResult"/>.
/// </summary>
/// <param name="Status">The inspection outcome.</param>
/// <param name="Evidence">The safe edit-evidence view (non-null only when <see cref="Status"/> is <see cref="AgentInteractionInspectionStatus.Success"/>).</param>
public record AgentProposalEditEvidenceResult(
    AgentInteractionInspectionStatus Status,
    AgentProposalEditEvidenceView? Evidence)
{
    /// <summary>Creates a successful inspection result carrying the given safe evidence view.</summary>
    /// <param name="evidence">The safe edit-evidence view.</param>
    /// <returns>A success result.</returns>
    public static AgentProposalEditEvidenceResult Success(AgentProposalEditEvidenceView evidence)
    ...
    public static AgentProposalEditEvidenceResult NotAuthorized()
    ...
    public static AgentProposalEditEvidenceResult NotFound()
